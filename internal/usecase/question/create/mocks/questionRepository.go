...
// Create provides a mock function with given fields: ctx, q
func (_m *QuestionRepository) Create(ctx context.Context, q *question.Question) (*question.Question, error) {
	ret := _m.Called(ctx, q)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *question.Question) (*question.Question, error)); ok {
		return rf(ctx, q)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *question.Question) *question.Question); ok {
		r0 = rf(ctx, q)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *question.Question) error); ok {
		r1 = rf(ctx, q)
	} else {
		r1 = ret.Error(1)
	}
